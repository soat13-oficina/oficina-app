...
class AlterarOrdemDeServicoServiceTest {
    ...
    void deveAlterarOrdemDeServicoExistente() {
        ...
        clienteRepository.salvar(Cliente.reconstituir(clienteId1, "Maria", "20110101103", TipoCliente.PF));
        clienteRepository.salvar(Cliente.reconstituir(clienteId2, "Bianca", "20170707776", TipoCliente.PF));
        ...
        ordemDeServicoRepository.salvar(OrdemDeServico.abrir(
                ...
                Cliente.reconstituir(clienteId1, "Maria", "20110101103", TipoCliente.PF),
                veiculoOriginal));
